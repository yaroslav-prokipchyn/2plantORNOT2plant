...
const SeedZoneMoistureRanges = ({ data }) => {
  ...
  const mouseover = (d) => {
    ...
    return `Date: ${dateString}<br>SWC: ${swc.toFixed(
      2
    )} ${unit}<br>To Top of Optimal: ${to_7day_target.toFixed(2)} ${unit}`;
  };
  return (
    <Plot
      divId="seed-zone-moisture-ranges"
      data={[
        // Top Band
        {
...
export default SeedZoneMoistureRanges;
