...
<body>
    <div style="border: 1px solid #ccc; padding: 10px; margin-bottom: 20px;">
        ...
        <p>Welcome! You have been successfully registered in our <b>Preview</b> application.</p>
    ...
    <div style="border: 1px solid #ccc; padding: 10px; margin-bottom: 20px;">
        ...
        <p>Bem-vindo! Você foi registrado com sucesso em nossa aplicação <b>Preview</b>.</p>
    ...
    <div style="border: 1px solid #ccc; padding: 10px; margin-bottom: 20px;">
        ...
        <p>¡Bienvenido! Ha sido registrado con éxito en nuestra aplicación <b>Preview</b>.</p>
